        ...
        <View style={styles.headerContainer}>
            {
                colNames.map((colName, index) => {
                    ...
                    const justifyContent = (colType == COL_TYPES.STRING || colType == null) ? 'flex-start' : (colType == COL_TYPES.CHECK_BOX || colType == COL_TYPES.RADIO || COL_TYPES.Button) ? 'center' : 'flex-end'
                    let paddingLeft = 0;
                    let paddingRight = 0;
